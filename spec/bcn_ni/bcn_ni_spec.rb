...
RSpec.describe 'BcnNi', type: :feature do
  ...
  context "when request mode is set to :soap" do
    it 'should return the correct exchange rate of a determinated day' do
      # Fetch the exchange rate for September 15th, 2017
      exchange_rate = BcnNi.exchange_day(2017, 9, 15, request_mode: :soap)
    ...
    it 'should return the correct exchange rate table for a determinated month' do
      # Fetch the exchange rate table for September, 2017
      exchange_table = BcnNi.exchange_month(2017, 9, request_mode: :soap)
  ...
  context "when request mode is set to :scrapping" do
    it 'should return the correct exchange rate of a determinated day' do
      # Fetch the exchange rate for September 1st, 2017
      exchange_rate = BcnNi.exchange_day(2017, 9, 15, request_mode: :scrapping)
    ...
    it 'should return the correct exchange rate table for a determinated month' do
      # Fetch the exchange rate table for September, 2017
      exchange_table = BcnNi.exchange_month(2017, 9, request_mode: :scrapping)
