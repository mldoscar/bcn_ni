...
class BcnNi::Test < ActiveSupport::TestCase
  test "truth" do
    assert_kind_of Module, BcnNi
  end
  ...
  test 'Returns the correct exchange rate table for a determinated month' do
    ...
    assert_equal(
      expected_table, 
      exchange_table, 
      'Returned exchange rate table does not correspond to expected value'
    )
